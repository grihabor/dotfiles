...
local ts_select_dir = function(picker_name)
...
local ts_select_dir_for_grep = ts_select_dir("live_grep")
local ts_select_dir_for_find_files = ts_select_dir("find_files")
